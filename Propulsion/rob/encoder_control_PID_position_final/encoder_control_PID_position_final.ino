...
#define I2C_SLAVE_ADDRESS 9  // Adresse I2C de l'Arduino
...
void receiveEvent(int numBytes) {
  ...
  if (numBytes == 1) { // Vérifie si un seul octet (commande) a été reçu
    msg = Wire.read(); // Lit la commande depuis le bus I2C et la stocke dans receivedChar
    Serial.print(msg);
  }
}
...
void initMsg()
{
  ...
  if(Wire.available())
  {
    ...
    DeserializationError error = deserializeJson(doc, msgData);
    if(!error)
    {
